        ...
        {showSections && (
          <>
            <section className="section">
              <img src="/images/restaurantmenyen.PNG" alt="" />
            ...
            <section className="section">
              <img src="/images/energydrink.PNG" alt="" />
              <div className="sectionText">
            ...
            <section className="section">
              <img src="/images/rpgBoardgame.PNG" alt="" />
              <div className="sectionText">
                <h2>RPG Boardgame</h2>
            ...
            <section className="section">
              <img src="/images/potionGame.png" alt="" />
              <div className="sectionText">
            ...
            <section className="section">
              <img src="/images/tipsyTroll.png" alt="" />
              <div className="sectionText">
